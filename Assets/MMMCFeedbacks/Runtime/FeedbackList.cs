...
namespace MMMCFeedbacks.Core
{
    ...
    public struct FeedbackList : IEquatable<FeedbackList>
    {
        ...
        public void AddFeedback(string selectString,GameObject gameObject)
        {
            ...
            foreach (var type in types)
            {
                ...
                if (StringConversionUtility.SplitLast(feedback.MenuString) != selectString)continue;
                List.Add(feedback);
                feedback.Enable(gameObject);
            }
        }
