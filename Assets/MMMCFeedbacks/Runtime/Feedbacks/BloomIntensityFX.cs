...
{
    [Serializable]
    public class BloomIntensityFX : Feedback
    {
        public override int Order => 7;
        public override string MenuString => "Volume/Bloom/Intensity (Bloom)";
        ...
        protected override void OnPlay(CancellationToken token)
        {
            ...
            _bloom.EnableVolumeParameter(_bloom.intensity);
            _tween = _bloom.TweenIntensity(zero, one, duration)
        ...
        private void Initialize()
        {
            ...
            _bloom.intensity.value = _initialValue;
            _bloom.intensity.overrideState=_initialOverrideState;
        }

        private void SetInitial()
        {
            _initialActive=_bloom.active;
            _initialValue=_bloom.intensity.value;
            _initialOverrideState=_bloom.intensity.overrideState;
        }
    }
}