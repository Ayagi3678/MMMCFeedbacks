...
{
    [Serializable]
    public class ColorAdjustmentsContrastFX : Feedback
    {
        public override int Order => 7;
        public override string MenuString => "Volume/Color Adjustments/Contrast (Color Adjustments)";
        ...
        protected override void OnPlay(CancellationToken token)
        {
            ...
            _colorAdjustments.EnableVolumeParameter(_colorAdjustments.contrast);
            _tween = _colorAdjustments.TweenContrast(zero, one, duration)
        ...
        private void Initialize()
        {
            ...
            _colorAdjustments.contrast.value = _initialValue;
            _colorAdjustments.contrast.overrideState=_initialOverrideState;
        }

        private void SetInitial()
        {
            _initialActive=_colorAdjustments.active;
            _initialValue=_colorAdjustments.contrast.value;
            _initialOverrideState=_colorAdjustments.contrast.overrideState;
        }
    }
}