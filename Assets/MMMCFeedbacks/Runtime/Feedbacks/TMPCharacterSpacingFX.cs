...
{
    [Serializable]
    public class TMPCharacterSpacingFX : Feedback
    {
         public override int Order => 5;
        public override string MenuString => "UI/TMP/Character Spacing (TMP)";
        ...
        protected override void OnPlay(CancellationToken token)
        {
            ...
            _tween= target.TweenCharacterSpacing(zero,one,duration)
