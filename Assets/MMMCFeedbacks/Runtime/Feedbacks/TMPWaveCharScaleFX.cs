...
{
    [Serializable]
    public class TMPWaveCharScaleFX : Feedback
    {
         public override int Order => 5;
        public override string MenuString => "UI/TMP/Wave Char Scale (TMP)";
        ...
        [SerializeField] private Vector3 zero=Vector3.one;
        [SerializeField] private Vector3 one= Vector3.one*2;
        ...
        protected override void OnEnable(GameObject gameObject)
        {
            ...
            {
                if (resetToInitial) _tweenAnimator.SetCharScale(x,Vector3.one);
            };
        ...
        protected override void OnPlay(CancellationToken token)
        {
            ...
            {
                var i1 = i;
                var tween = target.TweenCharScale(i,  zero,one, duration)
